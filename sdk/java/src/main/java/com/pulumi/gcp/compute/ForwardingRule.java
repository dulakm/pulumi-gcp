 ...
 *             .build());
 * 
 *         var defaultResource = new Network(&#34;defaultResource&#34;, NetworkArgs.builder()        
 *             .name(&#34;website-net&#34;)
 *             .autoCreateSubnetworks(false)
 *             .build());
 * 
 *         var defaultResource2 = new Subnetwork(&#34;defaultResource2&#34;, SubnetworkArgs.builder()        
 *             .name(&#34;website-net&#34;)
 *             .ipCidrRange(&#34;10.0.0.0/16&#34;)
 *             .region(&#34;us-central1&#34;)
 *             .network(defaultResource.id())
 *             .build());
 * 
 *         var default_ = new ForwardingRule(&#34;default&#34;, ForwardingRuleArgs.builder()        
 *             .name(&#34;website-forwarding-rule&#34;)
 ...
 *             .allPorts(true)
 *             .allowGlobalAccess(true)
 *             .network(defaultResource.name())
 *             .subnetwork(defaultResource2.name())
 *             .build());
 * 
 *     }
 * }
 ...
 * 
 *     public static void stack(Context ctx) {
 *         var defaultResource = new TargetPool(&#34;defaultResource&#34;, TargetPoolArgs.builder()        
 ...
 *             .build());
 * 
 *         var defaultResource5 = new Network(&#34;defaultResource5&#34;, NetworkArgs.builder()        
 *             .name(&#34;website-net&#34;)
 *             .autoCreateSubnetworks(false)
 *             .routingMode(&#34;REGIONAL&#34;)
 *             .build());
 * 
 *         var defaultResource6 = new Subnetwork(&#34;defaultResource6&#34;, SubnetworkArgs.builder()        
 *             .name(&#34;website-net-default&#34;)
 *             .ipCidrRange(&#34;10.1.2.0/24&#34;)
 *             .region(&#34;us-central1&#34;)
 *             .network(defaultResource5.id())
 *             .build());
 * 
 *         var instanceTemplate = new InstanceTemplate(&#34;instanceTemplate&#34;, InstanceTemplateArgs.builder()        
 ...
 *             .networkInterfaces(InstanceTemplateNetworkInterfaceArgs.builder()
 *                 .network(defaultResource5.id())
 *                 .subnetwork(defaultResource6.id())
 *                 .build())
 *             .disks(InstanceTemplateDiskArgs.builder()
 ...
 *             .build());
 * 
 *         var defaultResource = new RegionTargetHttpProxy(&#34;defaultResource&#34;, RegionTargetHttpProxyArgs.builder()        
 *             .region(&#34;us-central1&#34;)
 *             .name(&#34;website-proxy&#34;)
 ...
 *             .build());
 * 
 *         var defaultResource6 = new Network(&#34;defaultResource6&#34;, NetworkArgs.builder()        
 *             .name(&#34;website-net&#34;)
 *             .autoCreateSubnetworks(false)
 *             .routingMode(&#34;REGIONAL&#34;)
 *             .build());
 * 
 *         var defaultResource7 = new Subnetwork(&#34;defaultResource7&#34;, SubnetworkArgs.builder()        
 *             .name(&#34;website-net-default&#34;)
 *             .ipCidrRange(&#34;10.1.2.0/24&#34;)
 *             .region(&#34;us-central1&#34;)
 *             .network(defaultResource6.id())
 *             .build());
 * 
 *         var instanceTemplate = new InstanceTemplate(&#34;instanceTemplate&#34;, InstanceTemplateArgs.builder()        
 *             .name(&#34;template-website-backend&#34;)
 ...
 *             .networkInterfaces(InstanceTemplateNetworkInterfaceArgs.builder()
 *                 .network(defaultResource6.id())
 *                 .subnetwork(defaultResource7.id())
 *                 .build())
 *             .disks(InstanceTemplateDiskArgs.builder()
 *                 .sourceImage(debianImage.applyValue(getImageResult -&gt; getImageResult.selfLink()))
 *                 .autoDelete(true)
 ...
 *             .build());
 * 
 *         var defaultResource5 = new Address(&#34;defaultResource5&#34;, AddressArgs.builder()        
 *             .name(&#34;website-ip-1&#34;)
 *             .region(&#34;us-central1&#34;)
 ...
 *             .build());
 * 
 *         var externalResource = new ForwardingRule(&#34;externalResource&#34;, ForwardingRuleArgs.builder()        

 ...
 *             .build());
 * 
 *         var exampleResource = new Service(&#34;exampleResource&#34;, ServiceArgs.builder()        
 *             .serviceId(&#34;example-service&#34;)
 *             .namespace(example.id())
 *             .build());
 * 
 *         var exampleResource2 = new Endpoint(&#34;exampleResource2&#34;, EndpointArgs.builder()        
 *             .endpointId(&#34;example-endpoint&#34;)
 *             .service(exampleResource.id())
 ...
 *             .build());
 * 
 *         var exampleResource = new Namespace(&#34;exampleResource&#34;, NamespaceArgs.builder()        
 *             .namespaceId(&#34;example-namespace&#34;)
 *             .location(&#34;us-central1&#34;)
 *             .build());
 * 
 *         var exampleResource2 = new Service(&#34;exampleResource2&#34;, ServiceArgs.builder()        
 *             .serviceId(&#34;example-service&#34;)
 *             .namespace(exampleResource.id())
 *             .build());
 * 
 *         var exampleResource3 = new Endpoint(&#34;exampleResource3&#34;, EndpointArgs.builder()        
 *             .endpointId(&#34;example-endpoint&#34;)
 *             .service(exampleResource2.id())
 *             .metadata(Map.ofEntries(
 *                 Map.entry(&#34;stage&#34;, &#34;prod&#34;),
 *                 Map.entry(&#34;region&#34;, &#34;us-central1&#34;)
 *             ))

 ...
 *             .build());
 * 
 *         var sourceResource = new Instance(&#34;sourceResource&#34;, InstanceArgs.builder()        
 *             .cluster(source.name())
 ...
 *             .build());
 * 
 *         var sourceResource2 = new Backup(&#34;sourceResource2&#34;, BackupArgs.builder()        
 ...
 *                 .backupName(sourceResource2.name())
 *                 .build())
 *             .build());
 * 

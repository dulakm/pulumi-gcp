 ...
 *             .build());
 * 
 *         var defaultResource = new Authority(&#34;defaultResource&#34;, AuthorityArgs.builder()        
 *             .location(&#34;us-central1&#34;)
 *             .pool(default_.name())
 ...
 *             .build());
 * 
 *         var defaultResource2 = new Certificate(&#34;defaultResource2&#34;, CertificateArgs.builder()        
 *             .location(&#34;us-central1&#34;)
 *             .pool(default_.name())
 *             .certificateAuthority(defaultResource.certificateAuthorityId())
 *             .lifetime(&#34;86000s&#34;)
 *             .name(&#34;cert-1&#34;)
 ...
 *             .build());
 * 
 *         var defaultResource = new CertificateTemplate(&#34;defaultResource&#34;, CertificateTemplateArgs.builder()        
 *             .location(&#34;us-central1&#34;)
 ...
 *             .build());
 * 
 *         var defaultResource2 = new Authority(&#34;defaultResource2&#34;, AuthorityArgs.builder()        
 *             .location(&#34;us-central1&#34;)
 *             .pool(default_.name())
 *             .certificateAuthorityId(&#34;my-authority&#34;)
 *             .config(AuthorityConfigArgs.builder()
 ...
 *             .build());
 * 
 *         var defaultResource3 = new Certificate(&#34;defaultResource3&#34;, CertificateArgs.builder()        
 *             .location(&#34;us-central1&#34;)
 *             .pool(default_.name())
 *             .certificateAuthority(defaultResource2.certificateAuthorityId())
 *             .name(&#34;my-certificate&#34;)
 *             .lifetime(&#34;860s&#34;)
 *             .pemCsr(StdFunctions.file(FileArgs.builder()
 *                 .input(&#34;test-fixtures/rsa_csr.pem&#34;)
 *                 .build()).result())
 *             .certificateTemplate(defaultResource.id())
 *             .build());
 * 
 *     }
 * }

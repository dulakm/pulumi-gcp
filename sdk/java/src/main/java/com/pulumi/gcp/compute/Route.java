 ...
 *             .build());
 * 
 *         var defaultResource2 = new ForwardingRule(&#34;defaultResource2&#34;, ForwardingRuleArgs.builder()        
 ...
 *             .destRange(&#34;0.0.0.0/0&#34;)
 *             .network(default_.name())
 *             .nextHopIlb(defaultResource2.id())
 *             .priority(2000)
 *             .build());
 * 
 *     }
 ...
 *             .build());
 * 
 *         var producerResource = new Subnetwork(&#34;producerResource&#34;, SubnetworkArgs.builder()        
 ...
 *             .build());
 * 
 *         var consumerResource = new Subnetwork(&#34;consumerResource&#34;, SubnetworkArgs.builder()        
 ...
 *             .subnetwork(producerResource.name())
 *             .build());
 * 
 *         var route_ilb = new Route(&#34;route-ilb&#34;, RouteArgs.builder()        
 *             .name(&#34;route-ilb&#34;)

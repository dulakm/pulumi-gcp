...
public final class TpuFunctions {
     ...
     *         final var available = TpuFunctions.getV2AcceleratorTypes();
     * 
     *         final var availableData = TpuFunctions.getV2RuntimeVersions();
     * 
     *         var tpu = new V2Vm(&#34;tpu&#34;, V2VmArgs.builder()        
     *             .name(&#34;test-tpu&#34;)
     *             .zone(&#34;us-central1-b&#34;)
     *             .runtimeVersion(availableData.applyValue(getV2RuntimeVersionsResult -&gt; getV2RuntimeVersionsResult.versions()[0]))

 ...
 *             .build());
 * 
 *         var testResource = new BucketObject(&#34;testResource&#34;, BucketObjectArgs.builder()        
 *             .name(&#34;job_load_bucket_object&#34;)
 *             .source(new FileAsset(&#34;./test-fixtures/test.parquet.gzip&#34;))
 *             .bucket(test.name())
 *             .build());
 * 
 *         var testResource2 = new Dataset(&#34;testResource2&#34;, DatasetArgs.builder()        
 *             .datasetId(&#34;job_load_dataset&#34;)
 *             .friendlyName(&#34;test&#34;)
 *             .description(&#34;This is a test description&#34;)
 *             .location(&#34;US&#34;)
 *             .build());
 * 
 *         var testResource3 = new Table(&#34;testResource3&#34;, TableArgs.builder()        
 *             .deletionProtection(false)
 *             .tableId(&#34;job_load_table&#34;)
 *             .datasetId(testResource2.datasetId())
 *             .build());
 * 
 *         var job = new Job(&#34;job&#34;, JobArgs.builder()        
 *             .jobId(&#34;job_load&#34;)
 *             .labels(Map.of(&#34;my_job&#34;, &#34;load&#34;))
 *             .load(JobLoadArgs.builder()
 *                 .sourceUris(Output.tuple(testResource.bucket(), testResource.name()).applyValue(values -&gt; {
 *                     var bucket = values.t1;
 *                     var name = values.t2;
 *                     return String.format(&#34;gs://%s/%s&#34;, bucket,name);
 *                 }))
 *                 .destinationTable(JobLoadDestinationTableArgs.builder()
 *                     .projectId(testResource3.project())
 *                     .datasetId(testResource3.datasetId())
 *                     .tableId(testResource3.tableId())
 *                     .build())
 *                 .schemaUpdateOptions(                
 *                     &#34;ALLOW_FIELD_RELAXATION&#34;,
 *                     &#34;ALLOW_FIELD_ADDITION&#34;)
 ...
 *     public static void stack(Context ctx) {
 *         for (var i = 0; i &lt; 2; i++) {
 *             new Dataset(&#34;sourceResource-&#34; + i, DatasetArgs.builder()            
 ...
 *         
 * }
 *         for (var i = 0; i &lt; sourceResource.length(); i++) {
 *             new Table(&#34;source-&#34; + i, TableArgs.builder()            
 *                 .deletionProtection(false)
 *                 .datasetId(sourceResource[range.value()].datasetId())
 ...
 *         
 * }
 *         var destResource = new Dataset(&#34;destResource&#34;, DatasetArgs.builder()        
 ...
 *             .deletionProtection(false)
 *             .datasetId(destResource.datasetId())
 ...
 * 
 *     public static void stack(Context ctx) {
 *         var source_oneResource = new Dataset(&#34;source-oneResource&#34;, DatasetArgs.builder()        
 ...
 *             .deletionProtection(false)
 *             .datasetId(source_oneResource.datasetId())

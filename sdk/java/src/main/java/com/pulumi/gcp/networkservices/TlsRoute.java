 ...
 *         var defaultResource = new HttpHealthCheck(&#34;defaultResource&#34;, HttpHealthCheckArgs.builder()        
 ...
 *             .build());
 * 
 *         var defaultResource2 = new TlsRoute(&#34;defaultResource2&#34;, TlsRouteArgs.builder()        
 *             .name(&#34;my-tls-route&#34;)
 ...
 *             .build());
 * 
 *         var defaultResource2 = new Mesh(&#34;defaultResource2&#34;, MeshArgs.builder()        
 *             .name(&#34;my-tls-route&#34;)
 *             .labels(Map.of(&#34;foo&#34;, &#34;bar&#34;))
 *             .description(&#34;my description&#34;)
 *             .build());
 * 
 *         var defaultResource3 = new TlsRoute(&#34;defaultResource3&#34;, TlsRouteArgs.builder()        
 *             .name(&#34;my-tls-route&#34;)
 *             .description(&#34;my description&#34;)
 *             .meshes(defaultResource2.id())
 *             .rules(TlsRouteRuleArgs.builder()
 *                 .matches(TlsRouteRuleMatchArgs.builder()
 *                     .sniHosts(&#34;example.com&#34;)
 *                     .alpns(&#34;http/1.1&#34;)
 ...
 *             .build());
 * 
 *         var defaultResource2 = new Gateway(&#34;defaultResource2&#34;, GatewayArgs.builder()        
 *             .name(&#34;my-tls-route&#34;)
 *             .labels(Map.of(&#34;foo&#34;, &#34;bar&#34;))
 *             .description(&#34;my description&#34;)
 *             .scope(&#34;my-scope&#34;)

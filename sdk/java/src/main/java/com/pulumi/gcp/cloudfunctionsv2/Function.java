 ...
 *             .build());
 * 
 *         var secretResource = new SecretVersion(&#34;secretResource&#34;, SecretVersionArgs.builder()        
 *             .secret(secret.name())
 *             .secretData(&#34;secret&#34;)
 *             .enabled(true)
 *             .build());
 ...
 *         final var project = &#34;my-project-name&#34;;
 * 
 *         final var projectData = OrganizationsFunctions.getProject();
 * 
 *         var bucket = new Bucket(&#34;bucket&#34;, BucketArgs.builder()        
 *             .name(String.format(&#34;%s-gcf-source&#34;, project))
 *             .location(&#34;US&#34;)
 ...
 *             .project(projectData.applyValue(getProjectResult -&gt; getProjectResult.projectId()))
 ...
 *             .members(String.format(&#34;serviceAccount:service-%s@gcf-admin-robot.iam.gserviceaccount.com&#34;, projectData.applyValue(getProjectResult -&gt; getProjectResult.number())))
 *             .build());
 * 
 ...
 *             .members(            
 *                 String.format(&#34;serviceAccount:service-%s@gcf-admin-robot.iam.gserviceaccount.com&#34;, projectData.applyValue(getProjectResult -&gt; getProjectResult.number())),
 *                 String.format(&#34;serviceAccount:service-%s@gcp-sa-artifactregistry.iam.gserviceaccount.com&#34;, projectData.applyValue(getProjectResult -&gt; getProjectResult.number())),
 *                 String.format(&#34;serviceAccount:service-%s@gs-project-accounts.iam.gserviceaccount.com&#34;, projectData.applyValue(getProjectResult -&gt; getProjectResult.number())),
 *                 String.format(&#34;serviceAccount:service-%s@serverless-robot-prod.iam.gserviceaccount.com&#34;, projectData.applyValue(getProjectResult -&gt; getProjectResult.number())),

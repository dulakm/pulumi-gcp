 ...
 *             .build());
 * 
 *         var apiGwResource = new ApiConfig(&#34;apiGwResource&#34;, ApiConfigArgs.builder()        
 *             .api(apiGw.apiId())
 ...
 *             .build());
 * 
 *         var apiGwResource2 = new Gateway(&#34;apiGwResource2&#34;, GatewayArgs.builder()        
 *             .apiConfig(apiGwResource.id())
